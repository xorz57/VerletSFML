...
int32_t main(int32_t, char *[])
{
    ...
    sf::RenderWindow window(sf::VideoMode(window_width, window_height), "Verlet",
    ...
    while (window.isOpen())
    {
            ...
            clock.getElapsedTime().asSeconds() >= object_spawn_delay)
        {
            ...
            solver.setObjectVelocity(
                object, object_spawn_speed * sf::Vector2f{cos(angle), sin(angle)});
