...
template <typename T> class RealNumberGenerator : public NumberGenerator {
private:
...
template <typename T> class IntegerNumberGenerator : public NumberGenerator {
public:
...
template <typename T> class RNGi {
private:
...
template <typename T> IntegerNumberGenerator<T> RNGi<T>::gen;
